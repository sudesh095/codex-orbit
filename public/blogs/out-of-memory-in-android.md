...
The following block automatically closes the resource:
...
**Solution:**  
Use **Lottie** or **AnimatedImageDrawable** which are memory-efficient.
...
```kotlin
.submit() // This is problem when we not clear the reference
```
...
![MEMORY_LEAK_TABLE](https://github.com/user-attachments/assets/f82e86ca-c146-4806-96c4-82b6bbe09f0d)
