  ...
  const expertise = [
    {
      ...
      description:
        "Expert in native Android development using Kotlin, Java, and Jetpack Compose. Building scalable and performant mobile applications."
    },
    {
      icon: Zap,
      title: "Performance Optimization",
      description:
        "Specialized in app performance tuning, memory management, and battery optimization for seamless user experiences."
    },
    {
      icon: Shield,
      title: "Security & Encryption",
      description:
        "Implementing robust security measures, encryption, and secure data storage for sensitive applications."
    },
    {
      icon: Users,
      title: "KMP & Cross-Platform",
      description:
        "Building cross-platform solutions with Kotlin Multiplatform, sharing business logic across Android, iOS, and web."
    }
  ];

  const handleResumeDownload = () => {
    window.open(
      "https://drive.google.com/file/d/1ONamCIU716FRfaBpBWTGbGg5NC7r4w2r/view",
      "_blank"
    );
  };
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start gap-6">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-400 max-w-xl mb-4">
                Senior Android & KMP Developer — Performance, Architecture,
                Security
              </p>
              <p className="text-sm text-gray-500 max-w-xl">
                Passionate about building high-performance mobile applications
                with clean architecture. Specialized in Kotlin Multiplatform,
                Jetpack Compose, and modern Android development practices.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <NeonButton variant="pink" onClick={() => navigate("/contact")}>
                Hire Me
              </NeonButton>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((stat, index) => {
                ...
                return (
                  <GlassCard
                    key={index}
                    className="p-6 text-center hover:border-[#17A7FF]/50 transition-all"
                  >
                    <Icon className="w-8 h-8 mx-auto mb-3 text-[#17A7FF]" />
                    <div className="text-3xl mb-1 text-[#DE3484]">
                      {stat.number}
                    </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {expertise.map((item, index) => {
            ...
            return (
              <GlassCard
                key={index}
                className="p-6 hover:border-[#17A7FF]/50 transition-all group"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 py-12 lg:py-16">
        <GlassCard className="p-12 text-center border-[#17A7FF]/30 bg-gradient-to-br from-[#17A7FF]/5 to-[#DE3484]/5">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            Explore my technical blogs and real-world Android solutions.
          </p>
          <NeonButton variant="pink" onClick={() => navigate("/blogs")}>
            Read Blogs
          </NeonButton>
        </GlassCard>
      </section>
